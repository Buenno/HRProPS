...
.PARAMETER ID
The ID of the employee for whom to retrieve the record.

.EXAMPLE
Get-HRPEmployee -ID 12345

This returns the employee record for the employee with the ID of 12345.
